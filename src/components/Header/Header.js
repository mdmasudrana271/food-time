...
import navImg from "../../assets/img/Screenshot 2023-05-14 144947.png";

const Header = () => {
  return (
    <div className="navbar bg-secondaryColor md:px-9">
        ...
        <div className="dropdown">
          ...
          >
            ...
            <div className=" flex justify-center items-center gap-3 mt-5">
              <button className="btn bg-primaryColor border-none rounded-3xl w-32">
                Login
              </button>
              <button className="btn btn-ghost btn-circle bg-primaryColor">
                <svg
                  width="29"
                  height="30"
                  viewBox="0 0 29 30"
      ...
      <div className="navbar-end hidden lg:flex">
        <ul className="menu menu-horizontal px-1">
          ...
          <li className="w-20">
            <select className="select w-full bg-secondaryColor">
              <option selected>EN</option>
              <option>BN</option>
            </select>
          </li>
      ...
      <div className="hidden items-center md:flex justify-center">
        <button className="btn bg-primaryColor border-none rounded-3xl w-[154px] ml-[80px]">
          Login
        </button>
        <button className="btn btn-ghost btn-circle bg-primaryColor ml-6">
          <svg
            width="29"
            height="30"
            viewBox="0 0 29 30"
